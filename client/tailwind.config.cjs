  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'brand-aqua-contrast': 'var(--brand-aqua-contrast)',
        ...
        'surface-message-in': 'var(--surface-message-in)',
        'surface-message-out': 'var(--surface-message-out)',
        ...
        'state-success': 'var(--surface-success)',
        'state-warning': 'var(--surface-warning)',
        'state-destructive': 'var(--surface-destructive-state)',
