      ...
      <Dialog as="div" className="relative z-50" onClose={onOpenChange}>
        ...
        >
          <div className={cn('fixed inset-0 flex w-screen items-center justify-center p-4')}>
            <DialogPanel
              className={cn(
                'settings-panel-theme max-h-[90vh] overflow-hidden rounded-xl rounded-b-lg bg-background pb-6 shadow-2xl backdrop-blur-2xl animate-in sm:rounded-2xl md:w-[680px]',
              )}
            >
              <DialogTitle
